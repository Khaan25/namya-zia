export default function HeroCircle() {
  return (
    <>
      ...
      <div className="absolute top-0 z-10 left-1/2 transform -translate-x-1/2 -translate-y-1/2 size-[1071px] bg-[#040404] rounded-full shadow-[0_0_200px_rgba(255,255,255,0.1)]" />
    </>
  )
}
