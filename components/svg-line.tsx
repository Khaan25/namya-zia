...
const LINE_COLOR = '#808080'  // Grey color
...
const SVGLineGlowAnimate: React.FC<SVGLineGlowAnimateProps> = ({ movementDelay = 0, id, additionalHeight = 0, initialGradientY = 0 }) => {
  ...
  return (
    <svg width="12" height={svgHeight} viewBox={`0 0 12 ${svgHeight}`} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <linearGradient id={`gradient-glow-${id}`} x1="6" y1={gradientPosition.y1} x2="6" y2={gradientPosition.y2} gradientUnits="userSpaceOnUse">
          <stop offset="0.38" stopColor={LINE_COLOR} stopOpacity="0"></stop>
          <stop offset="0.5" stopColor={LINE_COLOR} stopOpacity="0.8"></stop>
          <stop offset="0.62" stopColor={LINE_COLOR} stopOpacity="0"></stop>
        </linearGradient>

        <linearGradient id={`gradient-solid-${id}`} x1="6" y1={initialGradientY} x2="6" y2={svgHeight} gradientUnits="userSpaceOnUse">
...
export const SVGLine = ({ className }: { className?: string }) => {
  return (
